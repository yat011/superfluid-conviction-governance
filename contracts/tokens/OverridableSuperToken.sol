 ...
 * @author Superfluid
 */
abstract contract OverridableSuperToken is
    UUPSProxiable,
    OverridableSuperfluidToken,
    ISuperToken
{
    ...
    constructor(ISuperfluid host)
        OverridableSuperfluidToken(host)
    ...
    function _move(
        ...
        OverridableSuperfluidToken._move(from, to, amount.toInt256());
    ...
    function _mint(
        ...
        OverridableSuperfluidToken._mint(account, amount);
    ...
    function _burn(
        ...
        OverridableSuperfluidToken._burn(from, amount);

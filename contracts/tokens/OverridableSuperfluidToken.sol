 ...
 * @author Superfluid
 */
abstract contract OverridableSuperfluidToken is ISuperfluidToken {
            ...
            availableBalance = availableBalance
                ...
                .sub(
                    agreementDeposit > agreementOwedDeposit
                        ? (agreementDeposit - agreementOwedDeposit).toInt256()
                        : 0
                );
        }
    }
        ...
        returns (bool isSolvent)
    {
        ...
        int256 realtimeBalance = availableBalance.add(
    ...
    function makeLiquidationPayouts(
        ...
        address bondAccount = gov.getConfigAsAddress(
            _host,
            this,
        ...
        if (bailoutAmount == 0) {
            ...
            _balances[bondAccount] = _balances[bondAccount].add(
                signedRewardAmount
            );
            // - penalty applies
            _balances[penaltyAccount] = _balances[penaltyAccount].sub(
                signedRewardAmount
            );
            ...
            _balances[liquidator] = _balances[liquidator].add(
                signedRewardAmount
            );
            ...
            _balances[penaltyAccount] = _balances[penaltyAccount].add(
                signedBailoutAmount
            );
            ...
            emit Bailout(bondAccount, bailoutAmount);
